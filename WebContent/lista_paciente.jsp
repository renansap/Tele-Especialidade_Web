	...
	<div id="wrapper">
		...
		<div id="content-wrapper">
			...
			<div class="container-fluid">
				...
				<!-- Breadcrumbs-->
				<ol class="breadcrumb">
					<li class="breadcrumb-item"><a href="lista_conselho.jsp">Lista de
							Pacientes</a></li>
					<li class="breadcrumb-item active">Todos Pacientes</li>
				</ol>
								...
								<tbody>
									<%
										...
										for (int i = 0; i < lista.size(); i++) {
											out.write("<tr>");
											out.write("<td> " + lista.get(i).getCd_paciente() + " </td>");
											out.write("<td> " + lista.get(i).getNm_paciente() + " </td>");
											out.write("<td> " + lista.get(i).getDt_nascimento() + " </td>");
											out.write("<td><a href=\"cadastro_paciente.jsp?cod=" + lista.get(i).getCd_paciente() + "\"class=\"btn btn-default\">Acessar</a></td>");
										}
									%>
