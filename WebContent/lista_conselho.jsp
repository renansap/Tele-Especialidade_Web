...
<title>Lista de Conselhos</title>
</head>
			...
			<div class="container-fluid">
				...
				<ol class="breadcrumb">
					<li class="breadcrumb-item"><a href="lista_conselho.jsp">Lista de
							Conselhos</a></li>
					<li class="breadcrumb-item active">Todos Conselhos</li>
				</ol>
								...
								<tbody>
									<%
										...
										for (int i = 0; i < lista.size(); i++) {
											...
											out.write("<td> " + lista.get(i).getDs_conselho() + " </td>");
											out.write("<td> " + lista.get(i).getDs_sigla_conselho() + " </td>");
											out.write("<td><a href=\"CadastroConselho.jsp?cod=" + lista.get(i).getCd_conselho() + "\"class=\"btn btn-default\">Acessar</a></td>");
										}
									%>
